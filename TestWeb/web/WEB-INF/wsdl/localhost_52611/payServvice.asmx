...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/payServvice.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">payServvice</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="payServvice.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="payServvice.asmx?op=HelloWorld">HelloWorld</a>
              ...
              <li>
                <a href="payServvice.asmx?op=Payment">Payment</a>
...
<script type="application/json" id="__browserLink_initializationData">
    {"appName":"Unknown","requestId":"c03dd81e0cd04f19bb1a7a956ce2387c"}
</script>
<script type="text/javascript" src="http://localhost:56808/ce7a089cdb9e4774934d50fa66e9e6fd/browserLink" async="async"></script>
<!-- End Browser Link -->
